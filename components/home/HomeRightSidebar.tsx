...
export function HomeRightSidebar({
  ...
  if (categories.length === 0) {
    return (
      <div className="space-y-4">
        <p className="rounded-2xl border border-line bg-graphite-light p-4 text-sm text-muted-foreground">
  ...
  return (
    <div className="space-y-4">
      <section className="rounded-2xl border border-line bg-graphite-light p-4">
